...
///   // L: 128 = 0.5 * 256
///   // A: 255 = 1.0 * 255
///   let expected_green_hsla = Hsla::new(2048, 1024, 512, 255);
...
///   // A: 255 = 1.0 * 255
///   let expected_pink_hsla = Hsla::new(0, 1024, 769, 255);
...
///   // L: 193 = 0.5 * 256 (3/4 between black and white)
///   // A: 255 = 1.0 * 255
